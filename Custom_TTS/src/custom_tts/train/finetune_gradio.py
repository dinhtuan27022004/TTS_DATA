...
from custom_tts.api import F5TTS
from custom_tts.model.utils import convert_char_to_pinyin
from custom_tts.infer.utils_infer import transcribe
...
path_data = str(files("custom_tts").joinpath("../../data"))
path_project_ckpts = str(files("custom_tts").joinpath("../../ckpts"))
file_train = str(files("custom_tts").joinpath("train/finetune_cli.py"))
